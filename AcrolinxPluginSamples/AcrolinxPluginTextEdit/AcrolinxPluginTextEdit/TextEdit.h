...
- (void) closeSaving:(TextEditSavo)saving savingIn:(id)savingIn;  // Close an object.
...
- (TextEditDocument *) open:(id)x;  // Open an object.
- (void) print:(id)x printDialog:(BOOL)printDialog withProperties:(TextEditPrintSettings *)withProperties;  // Print an object.
